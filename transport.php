...
$metaTags = array(
    ...
    "description" => "Transport for travel agent with JalaninAja.",
    "keywords" => "Travel, Travelling, Travel Agent, JalaninAja, jalaninaja, Jalan-Jalan, Liburan"
);

// Output meta tags and data transport as JSON
echo json_encode(array("meta" => $metaTags, "data" => $dataTransport));
?>
